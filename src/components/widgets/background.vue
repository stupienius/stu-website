<template>
  <div id="background" class="w-100 absolute h-screen overflow-hidden">
    <p class="phar1 text-center font-mawn text-5xl text-neutral-950">
      {{ content }}
    </p>
    <p class="phar2 text-center font-mawn text-5xl text-neutral-950">
      {{ content }}
    </p>
  </div>
</template>
...
.phar1 {
  ...
  animation: rolldown1 60s linear infinite;
}
...
.phar2 {
  position: relative;
  transform: translateY(-200%);
  animation: rolldown2 60s linear infinite;
}
</style>
